...
const QuestionBankTagger: React.FC = () => {
  ...
  const handleAnalysisSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/sense-ai/question-bank-results?mode=analysis');
    } catch (error) {
  ...
  const handleGenerationSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to results page
      router.push('/sense-ai/question-bank-results?mode=generation');
    } catch (error) {
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mt-1">Analyze and categorize questions with AI-powered tagging</p>
            </div>
          </div>
