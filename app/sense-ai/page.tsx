...
const aiTools = [
  ...
  },
  {
    ...
    route: '/sense-ai/question-bank-tagger',
  },
  {
    key: 'paper-to-pixel',
    name: 'Paper-To-Pixel',
    description: 'Converts handwritten notes and diagrams into digital, editable formats.',
    icon: Brain,
    stats: { usage: '10K+', accuracy: '95%' },
    route: '/sense-ai/paper-to-pixel',
  },
  {
    key: 'click-to-clarify',
    name: 'Click-To-Clarify',
    description: 'Provides instant explanations and context for any selected text or image.',
    icon: Brain,
    stats: { usage: '12K+', accuracy: '98%' },
    route: '/sense-ai/click-to-clarify',
  },
  {
    key: 'question-to-clarity',
    name: 'Question-To-Clarity',
    description: 'Transforms complex questions into clear, concise, and understandable answers.',
    icon: Brain,
    stats: { usage: '8K+', accuracy: '90%' },
    route: '/sense-ai/question-to-clarity',
  }
];
              ...
              <motion.div
                ...
                onClick={() => {
                  if (tool.key === 'lesson-planner') {
                    router.push('/sense-ai/lesson-planner');
                  } else if (tool.key === 'question-bank-tagger') {
                    router.push('/sense-ai/question-bank-tagger');
                  } else if (tool.key === 'worksheet-generator') {
                    router.push('/sense-ai/worksheet-generator');
                  } else if (tool.key === 'teaching-aid-designer') {
                    router.push('/sense-ai/teaching-aid-designer');
                  } else if (tool.key === 'performance-analyzer') {
                    router.push('/sense-ai/student-performance-analyzer');
                  } else if (tool.key === 'content-differentiator') {
                    router.push('/sense-ai/content-differentiator');
                  } else if (tool.key === 'quiz-maker') {
                    router.push('/sense-ai/interactive-quiz-maker');
                  } else if (tool.key === 'homework-creator') {
                    router.push('/sense-ai/worksheet-homework-creator');
                  } else if (tool.key === 'ppt-slide-maker') {
                    router.push('/sense-ai/ppt-slide-maker');
                  }
                  if (tool.key === 'paper-to-pixel') {
                    router.push('/sense-ai/paper-to-pixel');
                  }
                  if (tool.key === 'click-to-clarify') {
                    router.push('/sense-ai/click-to-clarify');
                  }
                  if (tool.key === 'question-to-clarity') {
                    router.push('/sense-ai/question-to-clarity');
                  } 
                  // else {
