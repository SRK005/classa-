...
const EdueronQuestionsDialog: React.FC<EdueronQuestionsDialogProps> = ({ open, onClose, onUpdate, initialSelected = [], classId, schoolId }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-7xl w-[98vw] max-h-[90vh] overflow-y-auto relative animate-fade-in border border-gray-200">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 gap-4">
          <h2 className="text-2xl font-bold text-blue-700">Select Questions</h2>
